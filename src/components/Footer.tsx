  ...
  return (
    <footer className="bg-eden-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              >
                <img
                  src="https://res.cloudinary.com/dontocypb/image/upload/v1758269743/2a1cb2c1-07f6-4823-8804-484448087601.png"
          ...
          <div>
            ...
            <div className="mt-2 flex justify-center">
              <img
                ...
                src="https://res.cloudinary.com/dontocypb/image/upload/v1758120812/7452ed10-ac7c-4550-afbb-21a880676cb2.png"
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-600 text-white rounded-full p-3 shadow-lg z-50 transition-all duration-300 hover:scale-110"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
